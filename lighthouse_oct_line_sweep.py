...
Usage::
    ...
    uv run python lighthouse_oct_line_sweep.py
    uv run python lighthouse_oct_line_sweep.py --sweep-dx 0.45 --line-x -0.35
    uv run python lighthouse_oct_line_sweep.py --rally-wave332 --row1-x -0.3 --row2-x 0.3 --row3-x 0.9
"""
