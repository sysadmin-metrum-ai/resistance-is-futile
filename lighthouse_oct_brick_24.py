...
Usage::
    ...
    uv run python lighthouse_oct_brick_24.py
    uv run python lighthouse_oct_brick_24.py --slide-dx 0.40
    uv run python lighthouse_oct_brick_24.py --rally-wave332 --row1-x -0.3 --row2-x 0.3 --row3-x 0.9
"""
