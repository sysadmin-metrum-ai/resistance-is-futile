...
from src.swarm.scheduling import SwarmSchedule
from src.swarm.scheduling import RTL_LAND_SEQUENCE_DELAY_S
from src.swarm.scheduling import build_schedule as _build_schedule
from src.swarm.scheduling import sleep_until as _sleep_until
...
def _replan_for_remaining(plan: SwarmPlan, connections: list[DroneConnection], phase: str) -> SwarmPlan:
    minimum_size = _minimum_viable_swarm_size(
        plan.spec.swarm_size,
        plan.spec.pattern,
        require_full_swarm=plan.spec.require_full_swarm,
    )
...
def _minimum_viable_swarm_size(requested_size: int, pattern: str = "", *, require_full_swarm: bool = False) -> int:
